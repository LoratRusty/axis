  ...
  <style>
    ...
    *::after {
    ...
    .btn-navy:hover {
      ...
      box-shadow: 0 8px 24px rgba(27, 47, 110, .2)
    }
    ...
    .step:hover {
      ...
      box-shadow: 0 12px 32px rgba(27, 47, 110, .1)
    }
    ...
    .acceso:hover .ac-role {
      color: var(--white)
    }

    .acceso:hover .ac-label {
      color: rgba(255, 255, 255, .45)
    }

    .acceso:hover .ac-arrow {
      color: var(--sky)
    }
...
<body>
  ...
  <nav class="nav" id="nav">
    <a href="/" class="nav-brand">
      <img src="{{ asset('images/logo.png') }}" alt="AXIS" style="height:36px;width:auto;object-fit:contain;">
    </a>
    <div class="nav-right">
        ...
        <div class="step" data-aos="fade-up" data-aos-delay="0">
          ...
          <div class="step-icon">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 6.75V15m6-6v8.25M3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0l3.869-1.934A1.125 1.125 0 0021 17.82V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 00-1.006 0L3.622 5.689A1.125 1.125 0 003 6.695z" />
            </svg>
          </div>
  ...
  <footer>
    <div class="foot-l">
      <img src="{{ asset('images/logo.png') }}" alt="AXIS" style="height:28px;width:auto;object-fit:contain;opacity:0.6;filter:brightness(0) invert(1);">
    </div>
    <div class="foot-r">
